...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { length: @period.length, punch_in: @period.punch_in, punch_out: @period.punch_out }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { length: @period.length, punch_in: @period.punch_in, punch_out: @period.punch_out }
    assert_redirected_to period_path(assigns(:period))
  end
